# 🍔 TechFood Shared Libraries

[![Build](https://github.com/TechChallenge-Team/techfood-shared/actions/workflows/pipeline.yaml/badge.svg)](https://github.com/TechChallenge-Team/techfood-shared/actions/workflows/pipeline.yaml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Biblioteca compartilhada de componentes reutilizáveis para o ecossistema TechFood, distribuída como pacotes NuGet privados no GitHub Packages.
...
| -------------------------------- | ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **TechFood.Shared.Domain**       | Entidades, enums, value objects e validações de domínio | [![NuGet](https://img.shields.io/badge/nuget-1.0.0-blue)](https://github.com/orgs/TechChallenge-Team/packages) |
| **TechFood.Shared.Application**  | Exceções, extensões e recursos de aplicação             | [![NuGet](https://img.shields.io/badge/nuget-1.0.0-blue)](https://github.com/orgs/TechChallenge-Team/packages) |
| **TechFood.Shared.Infra**        | Persistência, Entity Framework e consistência eventual  | [![NuGet](https://img.shields.io/badge/nuget-1.0.0-blue)](https://github.com/orgs/TechChallenge-Team/packages) |
| **TechFood.Shared.Presentation** | Filtros, extensões ASP.NET Core e configurações Swagger | [![NuGet](https://img.shields.io/badge/nuget-1.0.0-blue)](https://github.com/orgs/TechChallenge-Team/packages) |
...
techfood-shared/
├── src/
│   ├── TechFood.Shared.Domain/          # Camada de domínio
│   │   ├── Common/
...
│   │   └── Enums/                       # Enumeradores
│   │
│   ├── TechFood.Shared.Application/     # Camada de aplicação
│   │   ├── Exceptions/                  # Exceções de aplicação
│   │   └── Extensions/                  # Métodos de extensão
│   │
│   ├── TechFood.Shared.Infra/          # Camada de infraestrutura
│   │   ├── Persistence/                 # Configurações EF Core
│   │   ├── EventualConsistency/         # Consistência eventual
│   │   └── UoW/                         # Unit of Work
│   │
│   └── TechFood.Shared.Presentation/    # Camada de apresentação
...
dotnet restore TechFood.Shared.sln
...
- [Pipeline Actions](https://github.com/TechChallenge-Team/techfood-shared/actions)
- [Releases](https://github.com/TechChallenge-Team/techfood-shared/releases)

## 💬 Suporte

Para questões ou problemas:

- Abra uma [Issue](https://github.com/TechChallenge-Team/techfood-shared/issues)
